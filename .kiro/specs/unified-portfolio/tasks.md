...
- [ ] 1.1 Create database migration for portfolio tables (REUSE-FIRST CHECK REQUIRED)
  ...
  - _Requirements: 1.1, 7.5, 7.6, 14.4_
...
- [ ] 3.1 Create portfolio snapshot API endpoint (REUSE-FIRST CHECK REQUIRED)
  ...
  - **IF NOT EXISTS**: Implement GET /api/portfolio/snapshot with scope parameter
...
- [ ] 4.4 Implement GET /api/portfolio/actions endpoint (REUSE-FIRST CHECK REQUIRED)
...
- [ ] 5.7 Create GET /api/portfolio/approvals endpoint (REUSE-FIRST CHECK REQUIRED)
...
- [ ] 7.4 Implement intent planning API endpoints (REUSE-FIRST CHECK REQUIRED)
  ...
  - **IF NOT EXISTS**: Create POST /api/portfolio/plan for plan creation
  - **IF NOT EXISTS**: Create POST /api/portfolio/plan/:id/simulate for simulation
  - **IF NOT EXISTS**: Create POST /api/portfolio/plan/:id/execute for execution
...
- [ ] 11.4 Implement GET /api/portfolio/copilot/stream endpoint (REUSE-FIRST CHECK REQUIRED)
