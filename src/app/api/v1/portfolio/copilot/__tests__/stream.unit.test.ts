/**
 * Copilot Stream SSE Unit Tests
 * 
 * Verifies that the SSE endpoint implementation includes proper API versioning headers
...
describe('GET /api/v1/portfolio/copilot/stream - Unit Tests', () => {
  describe('SSE Response Headers', () => {
    test('includes X-API-Version: v1 header', async () => {
      const url = 'http://localhost:3000/api/v1/portfolio/copilot/stream?scope=active_wallet&wallet=0x1234567890123456789012345678901234567890';
  ...
  describe('Query Parameter Validation', () => {
    ...
    test('accepts all_wallets scope without address', async () => {
      const url = 'http://localhost:3000/api/v1/portfolio/copilot/stream?scope=all_wallets';
      const request = new NextRequest(url);
    ...
    test('defaults to active_wallet scope when not specified', async () => {
      const url = 'http://localhost:3000/api/v1/portfolio/copilot/stream?wallet=0x1234567890123456789012345678901234567890';
      const request = new NextRequest(url);
    ...
    test('rejects invalid wallet address format', async () => {
      const url = 'http://localhost:3000/api/v1/portfolio/copilot/stream?scope=active_wallet&wallet=invalid-address';
      const request = new NextRequest(url);
  ...
  describe('Error Response Format', () => {
    test('error responses include apiVersion field', async () => {
      const url = 'http://localhost:3000/api/v1/portfolio/copilot/stream?scope=active_wallet&wallet=invalid';
      const request = new NextRequest(url);
