...
import { Search, Clock, Filter, Moon, Sun, HelpCircle, Layers } from 'lucide-react';
...
export function StickyToolbar({
  ...
  return (
    <div className={`sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b ${isCompact ? 'py-2' : ''}`}>
