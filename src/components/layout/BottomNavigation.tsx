import { Home, Activity, Fish, TrendingUp, Shield, Users, Brain, Twitter, Briefcase, ChevronUp } from "lucide-react";
...
const navigationItems: NavigationItem[] = [
  ...
  { id: "reports", label: "Reports", icon: Briefcase, isPremium: true },
