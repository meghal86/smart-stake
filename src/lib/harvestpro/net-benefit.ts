...
/**
 * Calculate net benefit for an opportunity candidate
 * 
 * @param opportunity - Opportunity candidate
 * @param taxRate - User's tax rate
 * @param gasEstimate - Estimated gas cost
 * @param slippageEstimate - Estimated slippage cost
 * @param tradingFees - Trading fees
 * @returns Harvest calculation
 */
export function calculateOpportunityBenefit(
  ...
  return calculateHarvestBenefit({
