...
export function PortfolioSimulation({ currentValue, onSimulate }: PortfolioSimulationProps) {
  ...
  const applyPreset = (scenario: SimulationScenario) => {
    ...
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">Portfolio Stress Test</h3>
        </div>
            ...
            {PRESET_SCENARIOS.map((scenario, index) => (
              <div key={index} className="p-4 rounded-lg border bg-card">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => applyPreset(scenario)}>
                    Apply
                  </Button>
                </div>
