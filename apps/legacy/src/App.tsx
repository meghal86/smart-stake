...
import MultiCoinSentiment from "./pages/MultiCoinSentiment";
import ScannerCompliance from "./pages/ScannerCompliance";
import WhaleAnalytics from "./pages/WhaleAnalytics";
            ...
            <AuthProvider>
              ...
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/market-intelligence" element={<MarketIntelligenceHub />} />
                  <Route path="/market-sentiment" element={<MarketSentiment />} />
                  <Route path="/multi-coin-sentiment" element={<MultiCoinSentiment />} />
                  <Route path="/scanner-compliance" element={<ScannerCompliance />} />
                  <Route path="/whale-analytics" element={<WhaleAnalytics />} />
                  <Route path="/whale-predictions" element={<WhalePredictions />} />
                  <Route path="/yields" element={<AppLayout><Yields /></AppLayout>} />
